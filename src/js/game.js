var ws = new WebSocket("ws://localhost:8000/lobby");
        ...
        function create ()
        {
            ...
            // player test //
            /////////////////
            players = [new Player(scene=this, x=0 * grid.cellHeight, y=0 * grid.cellHeight, width=grid.cellWidth, height=grid.cellHeight, speed=grid.cellHeight, color=0xff0000, "down"),new Player(scene=this, x=1 * grid.cellHeight, y=1 * grid.cellHeight, width=grid.cellWidth, height=grid.cellHeight, speed=grid.cellHeight, color=0xff0000, "down")];
